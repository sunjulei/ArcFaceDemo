...
public class Wdzc3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvinfo.setOnItemClickListener(new OnItemClickListener()// 为ListView添加项单击事件
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Wdzc3.this, InfoManage.class);// 创建Intent对象
    ...
    private void ShowInfo(int intType) {// 用来根据传入的管理类型，显示相应的信息
        ...
        OutaccountDAO outaccountinfo = new OutaccountDAO(Wdzc3.this);// 创建OutaccountDAO对象
