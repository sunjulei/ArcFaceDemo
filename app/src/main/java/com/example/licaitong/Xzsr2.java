    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new View.OnClickListener() {// 为保存按钮设置监听事件
            ...
            public void onClick(View arg0) {
                ...
                String strInMoney = e1.getText().toString();// 获取金额文本框的值
                if (!strInMoney.isEmpty()) {// 判断金额不为空
                    ...
                    Tb_inaccount tb_inaccount = new Tb_inaccount(
                            ...
                            .parseDouble(strInMoney), e2
                            .getText().toString(), sp1
                            .getSelectedItem().toString(),
                            e4.getText().toString(),
                            e5.getText().toString());
                    inaccountDAO.add(tb_inaccount);// 添加收入信息
                    // 弹出信息提示
                    Toast.makeText(Xzsr2.this, "收入数据添加成功",
                            Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Xzsr2.this, "请输入收入金额",
